...
def fm(x_train_num,x_test_num,y_train,y_test):
    try:
        ...
        print(f'good columns {f}') # good columns

        x_train_num = x_train_num.drop(['Parch_trim','Age_randam_trim','Embarked_randam_Q'], axis=1)
        x_test_num = x_test_num.drop(['Parch_trim','Age_randam_trim','Embarked_randam_Q'], axis=1)
